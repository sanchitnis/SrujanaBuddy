# Grand Challenge Studio — Course Coach SKILL

> **Slot**: `agents/course-coaches/instances/course-coach-gcs.md`
> **Reference**: [`reference/GCS Course context.md`](reference/GCS%20Course%20context.md)
> **Profile tracking**: `profiles/{full-name}.md` → `## GCS Project Track` section
