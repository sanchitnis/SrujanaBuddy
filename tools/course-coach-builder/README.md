...
3. **Course Coach skill** — A Socratic tutor skill file ready to drop into `agents/course-coaches/instances/`
...
knowledge/
  ...
  instances/
    [CourseCode]-[ShortName]/
      skill.md                       Course Coach skill (Socratic tutor, drop into agents/course-coaches/instances/)
```
...
| `skill_generator.py` | Generates Course Coach skill.md from instance template + NLM data |
...
| [agents/course-coach-builder.md](../../agents/course-coach-builder.md) | Agent spec for AI-assisted build/refresh/audit |
| [agents/course-coaches/_course-coach-instance-template.md](../../agents/course-coaches/_course-coach-instance-template.md) | Template used by skill_generator.py |
