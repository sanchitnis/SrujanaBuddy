#!/usr/bin/env python3
"""
Course Coach Builder — CLI entry point
...
async def _run(args: argparse.Namespace) -> None:
    ...
    print(f"\n{'[DRY RUN] ' if dry_run else ''}Course Coach Builder")
    ...
    # ── Step 4: Course Coach skill generation ──────────────────────────────
    ...
    if not dry_run:
        ...
        print(f"\nNext step: add skill.md to agents/course-coaches/instances/ and assign a slot (01-10).")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Course Coach Builder — generate wiki, workbook, and skill from a course descriptor.",
